...
def main():
    ...
    result_dir = './results_tensorboard_relu/' # directory where the results from the training are saved
    ...
    for i in range(max_step):
        ...
        if i%100 == 0:
            # output the training accuracy for every 100 iterations
